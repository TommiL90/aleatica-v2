...
export default function PxQUDSimples() {
  ...
  const { data, mutate, isLoading } = useSWR(
    `${process.env.API_URL}/SimplePrice/GetAllPaginated?${params}&Page=${pageIndex}&PageSize=${pageSize}&SearchCriteria=${searchInput}`,
    fetcher,
  )
  ...
  const breadcrumbs = [
    ...
    { label: 'Precios de unidades simples', link: null },
  ]
        ...
        <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-8">
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
            <Table
              ...
              titulo="Precios unidades simples"
              descripcion="Lista resumen de precios unidades simples."

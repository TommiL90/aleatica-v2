...
export default function RatioP() {
  ...
  const { data, mutate, isLoading } = useSWR(
    projectSelected !== null && projectSelected['value'] > 0
      ? `${process.env.API_URL}/Summary/GetPerformanceCatalogEstimation/${projectSelected['value']}?${params}`
      : '',
    fetcher,
  )
        ...
        <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-8">
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
            <TableQueryByProject
              ...
              titulo="PxQ ratio P"
              descripcion="Lista resumen de PXQ ratio P del proyecto."

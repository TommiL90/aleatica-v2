...
export default function PxQUDSimples() {
  ...
  const { data, mutate, isLoading } = useSWR(
    projectSelected !== null && projectSelected['value'] > 0
      ? `${process.env.API_URL}/Summary/GetPlanningPerformanceCatalogEstimationSummary/${projectSelected['value']}?${params}`
      : '',
    fetcher,
  )
  ...
  const breadcrumbs = [
    ...
    { label: 'PxQ actuacion 1', link: null },
  ]
        ...
        <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-8">
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
            <TableQueryByProject
              ...
              titulo="PxQ actuacion 2"
              descripcion="Lista resumen de PXQ actuacion 2 del proyecto."

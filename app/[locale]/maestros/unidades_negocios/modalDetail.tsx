                    ...
                    <>
                      ...
                      <div className="mb-6 grid gap-6 md:grid-cols-2">
                        <div className="mb-2 w-full border-gray-300 p-2">
                          ...
                          {data.result.mtBusinessUnitMtAdministrations.map(
                            (item: any, idx: number) => (
                              <span
                                key={idx}
                        ...
                        <div className="mb-2 w-full border-gray-300 p-2">
                          ...
                          {data.result.mtBusinessUnitMtGeographicalAreas.map(
                            (item: any, idx: number) => (
                              <span
                                key={idx}
                                id="badge-dismiss-green"
                      ...
                      <div className="mb-2 w-full border-gray-300 p-2">
                        ...
                        {data.result.mtRoadSections.map(
                          (item: any, idx: number) => (
                            <span
                              key={idx}
                              id="badge-dismiss-green"
                      ...
                      <div className="mb-6 grid gap-6 md:grid-cols-3">
                        ...
                        <div className="mb-2 w-full border-gray-300 p-2">
                          ...
                          <p className="text-sm text-gray-700">
                            {data.result.highDate.split('T')[0]}
                          </p>
                        </div>
                      </div>
                    </>

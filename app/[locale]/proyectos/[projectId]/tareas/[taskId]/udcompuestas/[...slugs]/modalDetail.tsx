                    ...
                    <>
                        ...
                        <>
                          <div className="mb-2 w-full border-gray-300  p-2 ">
                            ...
                            <p className="text-sm text-gray-700">
                              {props.itemSelected.compositeUdId}
                            </p>
                          </div>
                          <div className="mb-2 w-full border-gray-300  p-2 ">
                            <h2 className="mb-2 text-sm font-semibold text-gray-800">
                            ...
                            <p className="text-sm text-gray-700">
                              {props.itemSelected.compositeUdName}
                            </p>
                          </div>
                          <div className="mb-2 w-full border-gray-300  p-2 ">
                            <h2 className="mb-2 text-sm font-semibold text-gray-800">
                            ...
                            <div className="mb-2 w-full border-gray-300  p-2 ">
                              ...
                              <p className="text-sm text-gray-700">
                                {props.subcategorias.filter(
                                  (item: any) =>
                                    item.value ===
                                    props.itemSelected.mtSubCategoryActionId,
                                ).length > 0 ? (
                                  props.subcategorias.filter(
                                    (item: any) =>
                                      item.value ===
                            ...
                            <div className="mb-2 w-full border-gray-300  p-2 ">
                              ...
                              <p className="text-sm text-gray-700">
                                {props.especialidades.filter(
                                  (item: any) =>
                                    item.value ===
                                    props.itemSelected.mtSpecialtyActionId,
                                ).length > 0 ? (
                                  props.especialidades.filter(
                                    (item: any) =>
                                      item.value ===
                            ...
                            <div className="mb-2 w-full border-gray-300  p-2 ">
                              ...
                              <p className="text-sm text-gray-700">
                                {props.unidadesObra.filter(
                                  (item: any) =>
                                    item.value ===
                                    props.itemSelected.mtUnitOfMeasurementId.toString(),
                                ).length > 0 ? (
                                  props.unidadesObra.filter(
                                    (item: any) =>
                                      item.value ===
                          ...
                          <div className="mb-2 w-full rounded  border-gray-300 p-2">
                            ...
                            <p className="text-sm text-gray-700">
                              {props.itemSelected.simpleCatalogs.map(
                                (item: any, idx: number) => (
                                  <span
                                    key={idx}
                      ...
                      {tabIndex === 1 ? (
                        <Treeview
                          ...
                          data={{
                            name: `Ud compuesta: ${props.itemSelected.compositeUdName}`,
                            children: props.itemSelected.simpleCatalogs.map(
                              (item: any) => ({
                                name: `Ud simple: ${item.simpleUdName}`,
                                // attributes: {

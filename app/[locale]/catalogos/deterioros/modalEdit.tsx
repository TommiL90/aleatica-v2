...
import CatalogoDeterioroForm from '@/components/forms/catalogoDeterioro'
              ...
              <div className="relative bg-white  shadow dark:bg-gray-700">
                ...
                <div className="space-y-6 p-6">
                  {props.itemSelected === null ? (
                    ...
                    <CatalogoDeterioroForm
                      subcategorias={props.subcategorias}
                      especialidades={props.especialidades}
                      initValue={
                        props.itemSelected !== null
                          ? {
                              codigoDeterioro: props.itemSelected.codigo,
                              nombreDeterioro: props.itemSelected.tipo,
                              subcategoria: props.itemSelected.subCategoria,
                              especialidad: props.itemSelected.especialidad,
                            }
                          : null
                      }
                      buttonText="Guardar deterioro"

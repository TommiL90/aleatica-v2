                    ...
                    <>
                      <div className="mb-6 grid gap-6 md:grid-cols-2">
                        ...
                        <div className="mb-2 w-full border-gray-300 p-2">
                          ...
                          <p className="text-sm text-gray-700">
                            {data.result.departmentPosition}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="mb-2 w-full border-gray-300 p-2">
                        ...
                        <ul className="px-4">
                          {data.result.rols.map((item: any, idx: number) => (
                            <li key={idx}>
                              ...
                              <div>
                                {item.permissions.map(
                                  (permision: any, permisionIdx: number) => (
                                    <span
                                      key={permisionIdx}
                                      className="me-2 rounded border border-green-400 bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-gray-700 dark:text-green-400"
                                    >

...
export default function ModalNewItem(props: PropsModalNewItem) {
  ...
  const saveCalzada = async (values: any): Promise<any> => {
    let toastId
    try {
      ...
      const item: any = {
        id:
          dataFindById !== undefined && dataFindById.status == 200
            ...
            : 0,
        name: values.nombreCalzada,
        code: values.codigoCalzada,
      }
                      ...
                      initValue={
                        dataFindById !== undefined && dataFindById.status == 200
                          ? {
                              ...
                              nombreCalzada: dataFindById.result.name,
                              codigoCalzada: dataFindById.result.code,
                            }
                          : null
                      }
                      buttonText="Guardar"
                      onSubmit={saveCalzada}
                    />
                  )}
                </div>
              </div>

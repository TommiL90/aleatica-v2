...
import { CellChange, CellLocation, CellTemplates, CheckboxCell, Column, DateCell, DefaultCellTypes, DropdownCell, DropdownCellTemplate, Id, MenuOption, NumberCell, ReactGrid, Row, TextCell } from '@silevis/reactgrid';
...
import { SpecialtyAction, SubCategory, Subspeciality, UnitOfMeasurement } from '@/services/useGetRepositories';
import fetcher from '@/services/fetcher';
import useSWR from 'swr';
import { DateFieldCellTemplate } from '../components/cells/date';
import { MaskFieldCellTemplate } from '../components/cells/input_mask';
...
export default function SimpleCatalog({esp, subEsp, subCat, unitMeasurement}: SimpleCatalogProps) {
  ...
  const { data, mutate, isLoading } = useSWR<DataResponse<SimpleUnitPaginated>>(`${process.env.API_URL}/SimpleCatalog/GetAllPaginated?MtSpecialtyActionId=${filtroEspecialidad}&SearchByProp=simpleUdName&SearchCriteria=${searchInput}&PagesSize=2147483647`, fetcher)

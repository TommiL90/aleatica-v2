...
export default function ModalDetail(props: PropsModalDetailItem) {
  ...
  useEffect(() => {
    if (
      !props.itemSelected.subEspecialidad ||
      props.itemSelected.subEspecialidad.value === ""
    ) {
      return
    }

    const subEspId = props.itemSelected.subEspecialidad.value

    const fetchData = async () => {
      try {
        const res = await fetch(
          `${process.env.API_URL}/MtSubspeciality/FindById/${subEspId}`
        )
                    ...
                    <>
                      ...
                      {tabIndex === 0 ? (
                        <>
                          ...
                          <div className="mb-2 w-full border-gray-300  p-2 ">
                            ...
                            <p className="text-sm text-gray-700">
                              {props.itemSelected.nombreUnidadSimple}
                            </p>
                          </div>
                          <div className="mb-2 w-full border-gray-300  p-2 ">
                            <h2 className="mb-2 text-sm font-semibold text-gray-800">
                            ...
                            <p className="text-sm text-gray-700">
                              {props.itemSelected.descripcionUnidadSimple}
                            </p>
                          </div>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="mb-2 w-full rounded  border-gray-300 p-2">
                              ...
                              <p className="text-sm text-gray-700">
                                {props.itemSelected.subEspecialidad !== null ? (
                                  <span
                                  ...
                                  >
                                    {props.itemSelected.subEspecialidad.label}
                                  </span>
                                ) : (
                                  `-`
                                )}
                            ...
                            <div className="mb-2 w-full border-gray-300  p-2">
                              <h2 className="mb-2 text-sm font-semibold text-gray-800">
                                Jerarquía de la subespecialidad
                              </h2>
                              <p className="text-sm text-gray-700">
                                {subEspecilityFather
                                  ? subEspecilityFather
                      ...
                      {tabIndex === 1 ? (
                        <Treeview
                          ...
                          data={{
                            name: `Ud simple: ${props.itemSelected.nombreUnidadSimple}`,
                            children: props.itemSelected.subEspecialidad
                              ? [
                                  {
                                    name: `Sub: ${props.itemSelected.subEspecialidad.label}`,
                                    // attributes: {
                                    ...
                                    // },
                                    children: subEspecilityFather
                                      ? [{ name: subEspecilityFather }]
                                      : [],
                                  },
                                ]
                              : [],

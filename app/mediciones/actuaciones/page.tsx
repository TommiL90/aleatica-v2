...
const actuaciones: Item[] = [
  {
    id: `MM.OP.CEM.24.001_RE011`,
    nombre: `Refuerzo del pavimento en troncal - Tramo 1.1`,
    unidad: 'ml',
    ambito: 'Carril',
    medicion: '0',
  },
  {
    id: `MM.OP.CEM.24.001_RE021`,
    nombre: `Refuerzo del pavimento en troncal - Tramo 2.1`,
    unidad: 'ml',
    ambito: 'Carril',
    medicion: '0',
  },
  {
    id: `MM.OP.CEM.24.001_RE022`,
    nombre: `Refuerzo del pavimento en troncal - Tramo 2.2`,
    unidad: 'ml',
    ambito: 'Carril',
    medicion: '0',
  },
  {
    id: `MM.OP.CEM.24.001_RE012`,
    nombre: `Refuerzo del pavimento en troncal - Tramo 1.2`,
    unidad: 'ml',
    ambito: 'Carril',
    medicion: '13.000',
  },
...
export default function MedicionesActuaciones() {
  const [columnsValues, setColumnsValues] = useState(actuaciones)
        ...
        <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-8">
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
            <Table
              ...
              searchInputPlaceholder="Buscar mediciones actuaciones"

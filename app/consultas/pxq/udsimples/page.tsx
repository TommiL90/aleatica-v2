...
export default function PxQUDSimples() {
  ...
  const { data, mutate, isLoading } = useSWR(
    projectSelected !== null && projectSelected['value'] > 0
      ? `${process.env.API_URL}/Summary/GetPlanningSimpleCatalogEstimationSummary/${projectSelected['value']}?${params}`
      : '',
    fetcher,
  )
  ...
  const breadcrumbs = [
    ...
    { label: 'PxQ de unidades simples', link: null },
  ]
        ...
        <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-8">
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
            <TableQueryByProject
              ...
              titulo="PxQ unidades simples"
              descripcion="Lista resumen de PXQ simples del proyecto."

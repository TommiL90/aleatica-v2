...
export default function MaestroCategoriaActuacion() {
  ...
  const { data, mutate, isLoading } = useSWR(
    `${process.env.API_URL}/MtDepartment/GetAllPaginated?Page=${pageIndex}&PageSize=${pageSize}&SearchByProp=Code&SearchCriteria=${searchInput}`,
    fetcher,
  )
  const mutation = useSWRMutation(
    `${process.env.API_URL}/MtDepartment/DeleteAll`,
    deleter,
  )
        ...
        <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-8">
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
            <Table
              ...
              descripcion="Repositorio con los diferentes departamentos."
              ...
              searchInputPlaceholder="Buscar departamento"
              ...
              columsLabels={['Nombre', 'Departamento']}
              columsActions={[
                {
                  label: 'Detalles',

          ...
          <div className='w-7/12'> 
            <div className='mb-6'>
              ...
              <Select
                id="newEntry"
                instanceId={newId}
                placeholder="Selecciona deterioro"
                className='mt-2 block rounded-lg border bg-gray-100 text-sm  text-gray-900 focus:border-gray-400 focus:ring-gray-400 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500'
                
                options={disjoinLists(
                  deteriorosList,
                  items,
                  "value"

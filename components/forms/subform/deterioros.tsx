        ...
        <div className="w-7/12">
          <div className="mb-6">
            ...
            <Select
              ...
              options={disjoinLists(props.deteriorosList, items, 'value')}
          ...
          {/* <div >
              <label className='mb-4 font-semibold'> Su</label>
          ...
          <div>
            ...
            <p className="m-4 text-sm text-gray-600">
              {currentSelectValue !== null
                ? currentSelectValue['subcategoria']
                : `-`}
              /
              {currentSelectValue !== null
                ? currentSelectValue['especialidad']
                : `-`}
            </p>
          </div>
          <div>
                ...
                items.map((item: any, idx: number) => (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={(e: any) =>
                        handleEliminarDeterioro(e, item.value)
                      }

...
import PermissionList from '@/components/inputs/permissionList'
...
const SchemaForm = Yup.object().shape({
  name: Yup.string()
    ...
    .required('Requerido'),
  permissionList: Yup.array().min(
    1,
    'Debe seleccionar minimo un permiso para crear un rol',
  ),
})

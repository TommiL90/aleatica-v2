...
const SchemaForm = Yup.object().shape({
  ...
  year: Yup.number()
    .min(2000, 'Demasiado corto!')
    .max(2100, 'Demasiado largo!')
    .required('Requerido'),
})

function IndicadorYear(props: FormProps) {
  ...
  return (
    <>
      <Formik
        initialValues={
          props.initValue !== null ? props.initValue : initialValues
        }
                ...
                {({
                  ...
                  <div>
                    <input
                      ...
                      id="year"
                      type="number"
                      placeholder="Inserte anno"
                      value={value}
                      defaultValue={
                        props.initValue !== null ? props.initValue.year : value
                      }
                      onChange={(evt: any) =>

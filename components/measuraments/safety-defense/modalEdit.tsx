import MedicionFichaCampoForm from '@/components/forms/mediciones/medicionFichaCampoSafetyDefense'
            ...
            <div className="space-y-6 p-6">
              {props.itemSelected !== undefined ? (
                <MedicionFichaCampoForm
                  ...
                  disposiciones={props.disposiciones}
                  initValue={
                    props.itemSelected !== null
                      ? {
                          ...
                          tipologia: props.itemSelected.tipologia,
                          posicion: props.itemSelected.posicion,
                          disposicion: props.itemSelected.disposicion,

...
export const getSafetyMediciones = (): Medicion[] => []

export const getSafetyColumns = (): Column[] => [
...
export const getSafetyEmpty = (id: number = 1): Medicion => ({
  idauto: id,
  id: 0,
  idUnidad: '',
  fechaPrevia: '',
...
export const moreSafetyRows = (
  mediciones: Medicion[],
  exceed: number = 100,
) => [
  ...mediciones,
  ...Array.from({ length: exceed }, (item, idx) => ({
    ...getSafetyEmpty(mediciones.length + 1),

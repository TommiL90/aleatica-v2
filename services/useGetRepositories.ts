...
export const getRepositories = async () => {
  ...
  try {
    const [
      ...
      fetcher(`${process.env.API_URL}/CompositeCatalog/GetAll`) as Promise<Response<CompositeCatalog>>,
      fetcher(`${process.env.API_URL}/MtAccidentRoadSection/GetAll`) as Promise<Response<Tca>>,
      fetcher(`${process.env.API_URL}/MtSubCategoryAction/GetDropdownItems?fieldNameValue=Id&fieldNameText=Name`) as Promise<Response<SubCategory>>,
      fetcher(`${process.env.API_URL}/MtSpecialtyAction/GetAll`) as Promise<Response<SpecialtyAction>>,
      fetcher(`${process.env.API_URL}/MtProjectCategory/GetAll`) as Promise<Response<ProjectCategory>>,
      fetcher(`${process.env.API_URL}/MtActionCategory/GetAll`) as Promise<Response<ActionCategory>>,
      fetcher(`${process.env.API_URL}/MtRoadSection/GetAll`) as Promise<Response<MtRoadSection>>,
      fetcher(`${process.env.API_URL}/MtUnitOfMeasurement/GetAll`) as Promise<Response<UnitOfMeasurement>>,
      fetcher(`${process.env.API_URL}/MtScopeOfAction/GetAll`) as Promise<Response<ScopeOfAction>>,
      fetcher(`${process.env.API_URL}/MRPerformanceIndicator/GetAll`) as Promise<Response<PerformanceIndicator>>,
      fetcher(`${process.env.API_URL}/MtSubspeciality/GetAll`) as Promise<Response<Subspeciality>>,
    ]);
